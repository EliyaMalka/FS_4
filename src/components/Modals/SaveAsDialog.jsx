/**
 * ==============================================
 * SaveAsDialog.jsx — חלון "שמירה בשם"
 * ==============================================
 * חלון קופץ שמאפשר לבחור שם חדש למסמך ולשמור אותו.
 * השדה מגיע מלא עם השם הנוכחי (שאפשר לשנות).
 * כפתור Save חסום כשהשם ריק.
 * שימושי כשרוצים ליצור עותק של מסמך קיים בשם אחר.
 */
