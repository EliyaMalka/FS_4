/**
 * ==============================================
 * OpenFileDialog.jsx — חלון פתיחת מסמך שמור
 * ==============================================
 * חלון קופץ שמציג רשימת כל המסמכים ששמורים ב-LocalStorage של המשתמש.
 * כל שורה מציגה: שם המסמך, מספר תווים, ותאריך שמירה אחרון.
 * לחיצה על מסמך → פותח אותו לעריכה וסוגר את החלון.
 * אם אין מסמכים שמורים — מציג הודעה מתאימה.
 */
import './Modals.css';
