/**
 * ==============================================
 * SavePrompt.jsx — חלון "שמור לפני סגירה"
 * ==============================================
 * חלון קופץ (modal) שמופיע כשמנסים לסגור מסמך שיש בו שינויים לא שמורים.
 * מציג שלוש אפשרויות:
 *   - Save — שומר את המסמך ואז סוגר אותו
 *   - Don't Save — סוגר בלי לשמור (השינויים יאבדו)
 *   - Cancel — חוזר למסמך בלי לסגור
 */
import './Modals.css';
